      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: AppColors.softBeige.withOpacity(0.6),
            ...
            child: Row(
              ...
              children: [
                ...
                StatChip(
                  label: 'Favorites',
                  value:
                      '${grouped.entries.where((e) => e.key.year == focusedDay.year && e.key.month == focusedDay.month).expand((e) => e.value).where((m) => m.isFav).length}',
                  emoji: '⭐',
                ),
              ],
            ),
